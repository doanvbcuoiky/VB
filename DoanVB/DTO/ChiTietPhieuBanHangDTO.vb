Public Class ChiTietPhieuBanHangDTO
    ...
    Public Sub New(ByVal maPhieuBan As String, ByVal maHangHoa As String, ByVal donVi As String, ByVal soLuong As Integer, ByVal donGia As Double, ByVal chietKhau As Double)
